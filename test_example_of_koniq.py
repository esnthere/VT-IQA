...
def main():
    ...
    model.load_state_dict(torch.load('VTIQA_koniq.pt'))
    # model.load_state_dict(torch.load("livew244_768patch2_4.pt"))
...
#########################################################
    ...
    test_loader = DataLoader(test_dataset, batch_size=batch_size*1, shuffle=False, num_workers=num_workers_test,
                              pin_memory=True)
